...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function rukuDaochu()
           {
               var url="<%=path %>/admin/ruku/rukuDaochu.jsp";
			   window.location.href=url;
           }
	...
	<div id="background" style="position:absolute;z-index:-1;width:100%;height:100%;top:0px;left:0px;"><img src="<%=path %>/images/left.png" width="100%" height="100%"/></div>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA">
				...
				<c:forEach items="${sessionScope.rukuList}" var="ruku" varStatus="sta">
			...
			<input type="button" value="添加进货信息" style="width: 120px;margin-top: 10px;" onclick="rukuAdd()" />
			<input type="button" value="导出excel" style="width: 120px;margin-top: 10px;" onclick="rukuDaochu()" />

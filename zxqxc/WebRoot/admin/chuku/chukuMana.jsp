...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function chukuDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/chukuDel.action?id="+id;
               }
           }
           ...
           function chukuDaochu()
           {
               var url="<%=path %>/admin/chuku/chukuDaochu.jsp";
			   window.location.href=url;
           }
       </script>
	</head>
	...
	<div id="background" style="position:absolute;z-index:-1;width:100%;height:100%;top:0px;left:0px;"><img src="<%=path %>/images/left.png" width="100%" height="100%"/></div>
			...
			<input type="button" value="添加销售信息" style="width: 110px;margin-top: 10px;" onclick="chukuAdd()" />
			<input type="button" value="导出excel" style="width: 120px;margin-top: 10px;" onclick="chukuDaochu()" />
	</body>
</html>
